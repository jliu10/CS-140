class MiniBankAccountSync implements MiniBankAccountFunctions
{
	...
	MiniBankAccountSync(String ownerLastName, String ownerFirstName)
	{
	...
	public synchronized void withdrawFromChecking(double amount)
	{
	...
	public synchronized void withdrawFromSavings(double amount)
	{
	...
	public synchronized void depositToSavings(double amount)
	{
	...
	public synchronized void depositToChecking(double amount)
	{
	...
	public synchronized void transferFromSavingsToChecking(double amount)
	{
	...
	public synchronized void transferFromCheckingToSavings(double amount)
	{
