...
// $ javac -classpath junit-platform-console-standalone-1.8.2.jar:. BinarySearchTreeTest.java
// $ java -jar junit-platform-console-standalone-1.8.2.jar --class-path . --select-class BinarySearchTreeTest

class BinarySearchTreeTest
{
	// use this binary search tree for the smaller trees
	liu_BinarySearchTree tree;

	// use this binary search tree for the 31 key tree
	liu_BinarySearchTree t;
	...
	void setUp() throws Exception
	{
		...
		tree = new liu_BinarySearchTree();

		// tree to use for the tests related to the 31 key tree
		t = new liu_BinarySearchTree();
